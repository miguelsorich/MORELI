...
// Optional environment variable overrides for custom domains
...
export const firebaseConfig = {
  ...
  firestoreDatabaseId: env.VITE_FIREBASE_DATABASE_ID || firebaseConfigJson.firestoreDatabaseId || '(default)'
};
